...
export default function Home() {
  return (
    <CustomCursor>
      <main className="flex flex-row min-h-screen min-w-screen justify-center text-white mix-blend-exclusion bg-zinc-900 bg-[radial-gradient(ellipse_80%_80%_at_50%_-20%,rgba(120,119,198,0.3),rgba(255,255,255,0))]">
        <MainScreen />
      </main>
    </CustomCursor>
  );
